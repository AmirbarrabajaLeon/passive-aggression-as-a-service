...
console.log(`- \x1b[1mReply Format:\x1b[0m        ${config.replyFormat.toUpperCase()}`);
console.log(
  `- \x1b[1mLLM Model:\x1b[0m           ${config.llmApiKey ? config.llmModel : '\x1b[33mDisabled (LLM_API_KEY not set)\x1b[0m'}`
);
console.log(
