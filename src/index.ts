...
const stickerCountLabel = initialStickers.length > 0
...
if (initialStickers.length === 0) {
  console.warn(`\x1b[33m[WARN]\x1b[0m No .webp stickers found in "${config.stickersDir}". Replies will be skipped until stickers are added.`);
}
